  ...
  <main id="main" class="main-page">
    ...
    <section id="speakers-details" class="wow fadeIn">
      <div class="container">
        <div class="section-header">
          ...
          <p>List of Upcoming Matches of Badminton</p>
        ...
        <?php
						...
						while($rws = $rs->fetch_assoc()){
                            ...
                            if(strcmp($rws['Category'],'Badminton') == 0 && $rws['Status'] == 0){
			?>
        <div class="row">
          <div class="col-md-6">
    ...
    <section id="speakers-details" class="wow fadeIn">
      <div class="container">
        <div class="section-header">
          <h2>Results</h2>
          <p>List of Results of Badminton</p>
        </div>
        <?php
						include 'includes/config.php';
						$sel = "SELECT * FROM scores";
						...
						while($rws = $rs->fetch_assoc()){
                            ...
                            if(strcmp($rws['Category'],'Badminton') == 0 && $rws['Status'] == 1) {
			?>

        <div class="row">
          <div class="col-md-6">
            <h2> <b>Event</b><?php echo '-'.$rws['Name'];?></h2>
            <h4> <?php echo  $rws['Player1'] ?>&nbsp;&nbsp;&nbsp;<?php echo  $rws['Score1'] ?></h4>
            <h4><?php echo $rws['Player2'] ?>&nbsp;&nbsp;&nbsp;<?php echo  $rws['Score2'] ?></h4>
            <h5><?php echo $rws['Result'] ?></h5>
